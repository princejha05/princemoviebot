...
PICS = (environ.get('PICS', 'https://envs.sh/HVM.jpg')).split()
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002241247230') # give your force subscribe channel id here else leave it blank
